...
public class Chatp2p1 {
    ...
    public static void main(String[] args) {
    	...
    	Chatp2p1 chat_app = new Chatp2p1();
    	chat_app.inputReader = new InputReader(args[3]);
    	logger.setOutPutFile(args[4]);
    	logger.log("Hello");
  ...
  //URL url = new URL("http", host, port + i, "");
        // localURL = new URL("ocsocket://"+InetAddress.getLocalHost().getHostAddress()+":"+port+"/");
          localURL = new URL("ocsocket://"+InetAddress.getLocalHost().getHostAddress()+"/");
          try {
              ...
              logger.log("node 1 jooined");
              logger.log("Node Id is "+chord1.getID()+ " and node length is "+chord1.getID().getLength());
    ...
    public  void printMainMenu() throws IOException, ServiceException {
        while (true) {
            ...
            int swValue = inputReader.getInt();
            ...
            if (retrieve_pwd.isEmpty()) {
                ...
                while (loop1) {
                  ...
                  //  String passwordString1 =Keyin.inString("Enter your password again");;
                    ...
                    String passwordString = inputReader.getString();

                    String passwordString1 =inputReader.getString();
                    ...
                    if (passwordString.equals(passwordString1)) {
                       ...
                       // System.out.println("User successflly registered");
                        logger.log("User successflly registered");
                        ...
                        try{
                        	...
                        	//System.out.println("Unable to open socket for chat Server which accpets incoming chat requests");
                        	logger.log("Unable to open socket for chat Server which accpets incoming chat requests");
                        }
                        ...
                        this.ConfListenerServerThread.start();
                        	...
                        	//System.out.println("Unable to open a socket for conference chat for user "+this.userID);
                        	logger.log("Unable to open a socket for conference chat for user "+this.userID);
                        }
                        ...
                        this.mgmtListenThd.start();
                        	...
                        	//System.out.println("Unable to open socket for listening manamgement requests");
                        	logger.log("Unable to open socket for listening manamgement requests");
                        	//e.printStackTrace();
                        	logger.log(e);
                        }
                        ...
                        this.mgmtRqstThd.start();
                        	...
                        	//System.out.println("Unable to open socket for sending mgmt requests ");
                        	logger.log("Unable to open socket for sending mgmt requests ");
                        	//e.printStackTrace();
                        	logger.log(e);
                        }
               ...
               // System.out.println("requested user id is already exists");
                logger.log("requested user id is already exists");                
            }
        }
    }
             ...
             case 1:
            	...
            	// System.out.println("user Id you want to chat with is "+ user_Id );
             	if(chatTable.get(user_Id)==null){
                     ...
                     logger.log("The port of the user is "+user_Port+" . The ip address is "+user_Ip);
             		...
             		try{
             			...
             			logger.log("Error in connecting with the user you want to chat with");
             			while(true){
             				if(print){
             					System.out.println("****************************************");
                                System.out.println("| Options:                                  |");
                           ...
                           // int swValue2 = Keyin.inInt(" Select option: ");
                            int swValue2 = inputReader.getInt();
                            if(swValue2 == 1){
                            	//String g = Keyin.inString("Please enter the message");
                            	String g = inputReader.getString();
                            	if(g!=null)
             ...
             case 3:
            	 ...
            	 for(String userId: frnd_lst){
            		// System.out.println("Friend UserId is "+userId);
            		 logger.log("Friend UserId is "+userId);
            	 }
                 break;
             case 4:
            	 return;
    ...
    private void conference(){
    	while(true){
            ...
            case 2:
            	...
            	String cfId = inputReader.getString();
            	Conference cfr = confTable.get(cfId);
            	if(cfr==null){
            		//System.out.println("Entered Conference Id is not Correct.Please enter the correct one. Cfid="+cfId);
            		//logger.log("Entered Conference Id is not Correct.Please enter the correct one. Cfid="+cfId);
            		break;
            	}
            	...
            	while(cnt){
                   ...
                   // sv = Keyin.inInt(" Select option: ");
                    ...
                    case 1:
                    	...
                    	if(this.confOutSockets.get(userToinvite)==null){
                    		try{
                        		...
                        		logger.log("The ipaddress of the user is "+IpAddress);
                        		String ConfPort="";
                        		try{
                        			...
                        			logger.log("Unable to get the conference port");
                        		}
                            	//System.out.println("The ipaddress of the user is "+IpAddress+" and conference port is "+ConfPort);
                            	logger.log("The ipaddress of the user is "+IpAddress+" and conference port is "+ConfPort);
                        		...
                        		logger.log("Error while retrieving the IP address of the user.");
                        		logger.log(e);
                        		e.printStackTrace();
                        	}
                    	}
                    ...
                    case 2:
                    	...
                    	String msgToSend = inputReader.getString();
            ...
            case 3:
            	...
            	logger.log("Printing the List of Conference");
            	int i=0;
